...
export const NEGATIVE_TIERS: Tier[] = [
    ...
    },
    {
        ...
        verdict:
            "A faint signal was logged, then dismissed as a lighting artifact.",
    },
    {
        min: 22,
...
export const DENIAL_BUTTON = "Yes I am gay - Let me in";
...
export const ACQUIRING_PROMPT =
    "Center your face in the reticle to acquire lock.";
...
export const TRACKING_ALERT: Record<TrackingReason, string> = {
    ...
    "looking-away":
        "Gaze deviation detected. Eyes forward — looking away will not help.",
};
